...
When this expansion code is run, `RANDOM` will be called each time
...
than absolutely necessary.<SUP>6</SUP> Furthermore, since `do-primes` is built
...
Another classic macro-writing MACRO: ONCE-ONLY</DIV>
